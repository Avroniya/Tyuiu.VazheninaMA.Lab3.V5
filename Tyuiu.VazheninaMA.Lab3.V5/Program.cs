...
namespace Tyuiu.VazheninaMA.Lab3.V5
{
    internal class Program
    {
        ...
        static void Option2()
        {
            ...
            Console.WriteLine(" " + cl.CalculateSecondExpression(a, x, y));
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("-------------------------------------------------------------------");
        ...
        static void Option3()
        {
            ...
            Console.WriteLine(" Math.Pow((Math.Pow(i, 2) + (1 / Math.Pow(i, 2))), i) - 12 * (Math.Pow(i, 2)) ");
            Console.WriteLine("-------------------------------------------------------------------");
            ...
            Console.WriteLine(" РЕЗУЛЬТАТ:                                                        ");
            Console.WriteLine("-------------------------------------------------------------------");
            double[] res = TabMathFunction.CalculateTabMathFunction(start, stop);
            Console.WriteLine("+------------+------------+");
        ...
        static void OptionF5()
        {
            ...
            Console.WriteLine(" Вычисляет матем. выражение  10 * x - ((x / y) / (2 * a / x)) + (3 * x + 2 * a - a) / (3 * a + 2 * x + y) - 2 * x");
            ...
            Console.WriteLine(" Программу разработала Важенина Мария Алексеевна | МКМб-22-1 | ТИУ 2024 ");
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("-------------------------------------------------------------------");
        ...
        static void Option4()
        {
            ...
            switch (c)
            {
                case "+":
                    ...
                    Console.WriteLine(Calculate.CalculateSumma(a, b));

                    break;

                case "-":
                    Console.WriteLine(a + " - " + b + " = ");
                    Console.WriteLine(Calculate.CalculateDifference(a, b));
                    break;

                case "*":
                    Console.WriteLine(a + " * " + b + " = ");
                    Console.WriteLine(Calculate.CalculateMultiplication(a, b));
                    break;

                case "/":
                    Console.WriteLine(a + " / " + b + " = ");
                    Console.WriteLine(Calculate.CalculateQuotient(a, b));
                    break;
        ...
        static void drawMainMenu()
        {
            ...
            Console.SetCursorPosition(0, 3);
            Console.Write("||                Выполнила Важенина Мария Алексеевна                      ||");
